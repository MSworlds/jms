...
public class SubMsg2 {
    ...
    private static String broker = "tcp://ids.demo.hengtiansoft.com:82";
    private static String userName = "admin";
    private static String passWord = "passwordad";
...
//         connOpts.setWill(topic, "close".getBytes(), 2, true);
    ...
    public static void main(String[] args) throws MqttException{
        ...
        runsub("test_client1", "realtimetombUAT/+");
    }
